...
The method, chapter \ref{chap:method}, describes the proposed approach in detail. This covers the components of the proposed architecture, the motivation behind the choices, the training and evaluation procedure.

The experiments, chapter \ref{chap:experiments}, entails details from other network choices to tricks explored to stabilize the \ac{gan} training. These details are important for the proper functioning and reproduction of the proposed method.

The results are presented and analyzed in chapter \ref{chap:results} and conclusions including discussion and future work are presented in chapter \ref{chap:conclusions}.
