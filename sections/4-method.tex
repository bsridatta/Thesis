...
As there is absolute target and metric for learning, this is a contrained optimization and directly corresponds to the error in learning the 3D pose. Hence this is kept low always
