...
% This chapter includes details that are impto make the method work. 
% and includes experiments using few hacks to emiliorate the \ac{gan} training, and development details. % FIXME development detials?
